...
#define GPIO_MODE_IT_FT			4	//Interrupt based , falling edge trigger
#define GPIO_MODE_IT_RT			5	//Interrupt based , Rising edge trigger
#define GPIO_MODE_IT_RFT		6	//Interrupt based, Rising edge-falling edge trigger
